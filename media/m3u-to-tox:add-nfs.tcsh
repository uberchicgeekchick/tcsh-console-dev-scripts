...
ex -E -n -s -X '+3,$s/^\#.*[\r\n]//' '+3,,$s/\v^(\/projects\/media|\/media\/[^\/]+)\/(.*)\/([^\/]+)(, released on[^\.]+)\.([^\.]+)$/entry \{\r\tidentifier\ =\ \3;\r\tmrl\ =\ \1\/nfs\/\2\/\3\4\.\5;\r\tav_offset\ =\ 3600;\r};\r/' '+1,$s/^\(\/projects\/media\|\/media\/[^\/]\+\)\/\(.*\)\/\([^\.]\+\)\.\([^\.]\+\)$/entry \{\r\tidentifier\ =\ \3;\r\tmrl\ =\ \1\/nfs\/\2\/\3\.\4;\r\tav_offset\ =\ 3600;\r};\r/' '+wq!' "${playlist}";
