...
ex -E -n -s -X '+3,$s/^\#.*[\r\n]//' '+3,$s/\v^(\/.*)\/nfs\/(.*)\/([^\/]+)(, released on[^\.]+)\.([^\.]+)$/entry \{\r\tidentifier\ =\ \3;\r\tmrl\ =\ \1\/\2\/\3\4\.\5;\r\tav_offset\ =\ 3600;\r};\r/' '+3,$s/^\(\/.*\)\/nfs\/\(.*\)\/\([^\/]\+\)\.\([^\.]\+\)$/entry \{\r\tidentifier\ =\ \3;\r\tmrl\ =\ \1\/\2\/\3\.\4;\r\tav_offset\ =\ 3600;\r};\r/' '+wq!' "${playlist}";
