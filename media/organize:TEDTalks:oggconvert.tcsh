...
set video_path="/old/projects/media/resources/archived-podcasts/video/tedtalks";
if(! -d "${video_path}" ) mkdir -p "${video_path}";
set ogg_path="/projects/media/resources/archived-podcasts/audio/tedtalks";
