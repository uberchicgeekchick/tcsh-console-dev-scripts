...
alias xfmedia "${condition}/usr/bin/xfmedia --video-out=${video_driver} --audio-out=${sound_driver} --vwin-geometry=${resolution}"
foreach resolution_source ( /profile.d/resolutions/video/* )
	...
	alias "xfmedia-${alias_suffix}" "${condition}/usr/bin/xfmedia --video-out=${video_driver} --audio-out=${sound_driver} --vwin-geometry='${resolution_source}'"
end
...
alias gpodder "/projects/tcsh-dev/media-organization/gPodder/gPodder:Silent:STDERR.tcsh"
